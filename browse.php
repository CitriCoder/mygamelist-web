    ...
    <nav class="navbar navbar-expand navbar-light bg-light" style="box-shadow: 0px 2px 3px #aaaaaa;">
      <div class="container-fluid">
        <a class="navbar-brand" href="index.php">MyGameList</a>
          ...
          <form class="form-inline my-0 hide">
          <input class="form-control form-control-sm" type="text" placeholder="Search" aria-label="Search" id="search" autocomplete="off">
          <!--<button class="btn btn-sm btn-outline-secdan my-2 my-sm-0" type="submit"><i class="bi bi-search"></i></button>-->
        </form>
        <?php
              ...
              echo'
                <div class="col-sm-6 col-md-4 col-lg-3  mb-4">
                  <div class="card">
                    ...
                    <img src="img/'.$row['fname'].'" class="img-fluid card-img-top" alt="'.$row['name'].'">
                    <div class="card-body py-2">
                      <strong class="card-title mb-0 txtmod">'.$row['name'].'</strong>
                      </a>
                    </div>
                  </div>
                </div>';
        ...
        $.ajax({
          ...
          success:function(response){
            ...
            tarea.forEach(dato=>{
              ...
              <div class="col-sm-6 col-md-4 col-lg-3  mb-4">
                <div class="card">
                  <a href="juego.php?juego=${dato.name}">
                  <img src="img/${dato.fname}" class="img-fluid card-img-top" alt="${dato.name}">
                  <div class="card-body py-2">
                    <strong class="card-title mb-0 txtmod">${dato.name}</strong>
                    </a>
                  </div>
                </div>
              </div>
